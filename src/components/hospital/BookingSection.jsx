...
const doctors = {
  'قسم القلب والأوعية الدموية': ['د. أحمد السيد', 'د. محمد الراشد'],
  'قسم الأعصاب': ['د. سارة العمري', 'د. خالد النجار'],
  'قسم العظام والمفاصل': ['د. محمد الحارثي', 'د. عمر فتحي'],
  'قسم طب العيون': ['د. ليلى حسن', 'د. يوسف المنصور'],
  'قسم طب الأطفال': ['د. فاطمة الزهراء', 'د. أحمد عبدالله'],
  'قسم المختبرات والتحاليل': ['د. نورا الجبر'],
  'قسم الطوارئ': ['د. رامي الشمري', 'د. هدى سالم'],
  'قسم الجراحة العامة': ['د. وليد الحمدان', 'د. سعد القحطاني'],
  'قسم النساء والتوليد': ['د. منى العتيبي', 'د. رانيا فاروق'],
  'قسم الأسنان': ['د. طارق عبدالرحمن', 'د. دينا سمير'],
};
